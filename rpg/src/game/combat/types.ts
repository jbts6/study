...
export type WorldUnit = Readonly<{ id: string; team: Team; cell: Cell; hp: number; maxHp: number; disabled: boolean; statuses: readonly Status[]; move?: number; attack?: number; defense?: number; skills?: readonly Readonly<Pick<Skill, "id" | "range" | "power" | "remainingCooldown" | "target" | "kind">>[] }>;
